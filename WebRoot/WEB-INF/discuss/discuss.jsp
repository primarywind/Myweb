                    ...
                    <div class="aw-mod aw-notification-box hide"
                        ...
                        <div class="mod-head common-head">
                            <h2>
                                    ...
                                    name="notification_unread_num">0</em>
                            </h2>
                        </div>
                        <div class="mod-body">
                        ...
                        <div class="mod-footer">
                            <div class="page-control">
                                <ul class="pagination pull-right" id="discussPaginationId">
                                    ...
                                    <li><a
                                            href="http://wenda.golaravel.com/sort_type-new__day-0__is_recommend-0__page-2">
                                        &gt;</a>
                                    </li>
                                    <li><a
                                            href="http://wenda.golaravel.com/sort_type-new__day-0__is_recommend-0__page-37">
                                        &gt;&gt;</a>
                                    </li>
                                </ul>
                            </div>
...
<script type="text/template" id="hotUserListId">
    <dl>
        <dt class="pull-left aw-border-radius-5">
            <a href="#"><img
                    alt=""
        ...
        <dd class="pull-left">
            <a href="#" data-id="1822"
               class="aw-user-name">{userName}</a>

            <p class="signature"></p>

            <p>
                <b>{sendCardNum}</b> 个话题, <b>{favoriteNum}</b> 次关注
            </p>
        </dd>
    </dl>
</script>
