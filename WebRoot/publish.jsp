				...
				<div class="aw-content-wrap clearfix">
					<div class="col-sm-12 col-md-9 aw-main-content">
						<form id="question_form">
							<input type="hidden" name="post_hash" value="4ff11aa9467e6c25" />
							<div class="aw-mod aw-mod-publish">
									...
									<div class="aw-publish-title active">
										<div>
											<input type="text" placeholder="问题标题..."
												name="question_content" id="question_contents" value=""
												class="form-control" />
										...
										<div class="mod-head">
											<div class="wmd-panel">
												...
												<textarea class="wmd-input form-control autosize"
													id="wmd-input" rows="15" name="question_detail"></textarea>
											</div>
										</div>
										<div class="mod-body">
								...
								<div class="mod-footer clearfix">
									<a href="http://wenda.golaravel.com/page/integral"
										...
										id="publish_submit"
										onclick="javascript:submitSendCardForm();">确认发起</a>
								</div>
							</div>
						</form>
					</div>
