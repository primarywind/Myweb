							...
							<div class="mod-head common-head">
								<h2>
									<a href="javascript:;" onclick="AWS.dialog('inbox', '');"
										class="pull-right btn btn-mini btn-success">新私信</a> <span
										class="pull-right aw-setting-inbox hidden-xs"><a
										class="text-color-999"
										href="http://wenda.golaravel.com/setting/privacy/#!inbox"><i
											class="icon icon-setting"></i> 私信设置</a>
									</span> 私信
								</h2>
							</div>
									...
									<div class="mod-head">
										...
										<p class="text-color-999">
											<span class="pull-right"><a
												href="http://wenda.golaravel.com/inbox/read/2669">共 1
													条对话</a> &nbsp; <a href="javascript:;" class="text-color-999"
